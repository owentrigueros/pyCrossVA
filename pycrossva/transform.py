...
def transform(mapping, raw_data, verbose=2, preserve_na=True,
    ...
    Examples:
        ...
        >>> phmrc_to_interva5 = pd.read_csv('resources/mapping_configuration_files/PHMRCShort_to_InterVA5.csv')
        >>> phmrc_to_interva5.iloc[:5,[0,2,4,-1]]
        ...
        >>> transform(phmrc_to_interva5, "resources/sample_data/PHMRC_mock_data_1.csv").iloc[:5,:5]
